...
export async function listSecrets() {
	...
	// Only attempt listing secret files if the secrets path actually exists on disk.
	if (await exists(SECRETS_BASE_PATH)) {
		return fsp.readdir(SECRETS_BASE_PATH);
	}
